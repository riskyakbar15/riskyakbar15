...
CONFIGURE: edit TITLE_TEXT and the ROWS list below with your own content.
Row kinds:
...
# terminal-title text shown in the SVG title bar
TITLE_TEXT = "riskyakbar15@github: ~$ neofetch"
...
ROWS = [
    ...
    ("kv", "Backend", "MySQL, Python, PostgreSQL"),
