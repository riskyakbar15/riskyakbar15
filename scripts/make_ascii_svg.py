...
CONFIGURE: change TITLE_TEXT / WHOAMI below, and drop your prepped image via
prep_photo.py first.
"""
...
# terminal-title text + whoami value shown in the status bar
TITLE_TEXT = "riskyakbar15@github: ~$ ./portrait.sh"
WHOAMI = "riskyakbar15"
